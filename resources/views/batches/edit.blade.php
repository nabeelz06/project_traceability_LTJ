...
@section('title', 'Edit Batch - Traceability LTJ')
...
<div class="container py-4">
    ...
    <div class="page-header">
        <h2><i class="bi bi-pencil-square me-2"></i>Edit Batch: {{ $batch->batch_code }}</h2>
    </div>

    <!-- Info Box -->
    <div class="info-box">
        <i class="bi bi-info-circle me-2"></i>
        <strong>Batch Code:</strong> {{ $batch->batch_code }} | 
        <strong>Status:</strong> {{ $batch->getStatusLabel() }} | 
        <strong>Dibuat:</strong> {{ $batch->created_at->format('d/m/Y H:i') }}
    </div>
    
    <div class="card">
        <div class="card-header">
            <i class="bi bi-pencil-square me-2"></i>Form Edit Batch LTJ
        </div>
        <div class="card-body">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <select id="product_code_id" name="product_code_id" class="form-select" required>
                            ...
                            <option value="{{ $code->id }}" {{ old('product_code_id', $batch->product_code_id) == $code->id ? 'selected' : '' }}>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="number" id="initial_weight" name="initial_weight" class="form-control" 
                                   step="0.001" min="0.001" value="{{ old('initial_weight', $batch->tonase) }}" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="konsentrat_persen" name="konsentrat_persen" class="form-control" 
                               step="0.01" min="0" max="100" value="{{ old('konsentrat_persen', $batch->konsentrat_persen) }}" 
                    ...
                    <div class="form-grid-5">
                        <div class="form-group">
                            ...
                            <input type="number" id="nd_content" name="nd_content" class="form-control unsur-ltj" 
                                   step="0.01" min="0" max="100" value="{{ old('nd_content', $batch->nd_content) }}" 
                                   placeholder="0.00">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="y_content" name="y_content" class="form-control unsur-ltj" 
                                   step="0.01" min="0" max="100" value="{{ old('y_content', $batch->y_content) }}" 
                                   placeholder="0.00">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="ce_content" name="ce_content" class="form-control unsur-ltj" 
                                   step="0.01" min="0" max="100" value="{{ old('ce_content', $batch->ce_content) }}" 
                                   placeholder="0.00">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="la_content" name="la_content" class="form-control unsur-ltj" 
                                   step="0.01" min="0" max="100" value="{{ old('la_content', $batch->la_content) }}" 
                                   placeholder="0.00">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="pr_content" name="pr_content" class="form-control unsur-ltj" 
                                   step="0.01" min="0" max="100" value="{{ old('pr_content', $batch->pr_content) }}" 
                                   placeholder="0.00">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="container_code" name="container_code" class="form-control" 
                               value="{{ old('container_code', $batch->container_code) }}" 
                               placeholder="Contoh: K-TMH-0001">
                        <span class="help-text">
                            <i class="bi bi-info-circle me-1"></i>
                            Format: K-TMH-XXXX
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="origin_location" name="origin_location" class="form-control" 
                               value="{{ old('origin_location', $batch->origin_location) }}" 
                               required placeholder="Contoh: Gudang PT Timah Bangka">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="keterangan" name="keterangan" class="form-control" rows="3" 
                                  placeholder="Tambahkan catatan tambahan (opsional)">{{ old('keterangan', $batch->keterangan) }}</textarea>
                    </div>
                </div>
